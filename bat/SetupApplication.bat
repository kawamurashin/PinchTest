...
:: Android packaging
set AND_CERT_NAME="PinchTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\PinchTest.p12
...
set IOS_PROVISION=cert\PinchTest.mobileprovision
...
set APP_ID=air.PinchTest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=PinchTest
